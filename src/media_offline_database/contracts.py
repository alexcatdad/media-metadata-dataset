...
CORE_TABLE_CONTRACTS: dict[str, TableContract] = {
    ...
    "source_snapshots": TableContract(
        table_name="source_snapshots",
        schema_version=CORE_SCHEMA_VERSION,
        compatibility_tier=CompatibilityTier.CORE,
        columns=(
            column("source_snapshot_id", "string", nullable=False),
            column("source_id", "string", nullable=False),
            column("source_role", "string", nullable=False),
            column("snapshot_kind", "string", nullable=False),
            column("fetched_at", "datetime", nullable=False),
            column("source_published_at", "datetime"),
            column("fetch_window_started_at", "datetime"),
            column("fetch_window_finished_at", "datetime"),
            column("source_version", "string"),
            column("policy_version", "string", nullable=False),
            column("publishable_field_policy_version", "string", nullable=False),
            column("artifact_policy_version", "string", nullable=False),
            column("record_count", "int64"),
            column("content_hash", "string"),
            column("manifest_uri", "string"),
            column("notes", "string"),
        ),
    ),
    "provider_runs": TableContract(
        table_name="provider_runs",
        schema_version=CORE_SCHEMA_VERSION,
        compatibility_tier=CompatibilityTier.CORE,
        columns=(
            column("provider_run_id", "string", nullable=False),
            column("source_id", "string", nullable=False),
            column("source_snapshot_id", "string"),
            ...
            column("request_count", "int64", nullable=False),
            column("cache_hit_count", "int64", nullable=False),
            column("status", "string", nullable=False),
            column("auth_shape", "string"),
            column("secret_refs", "list[string]", nullable=False),
            column("notes", "string"),
        ),
    ),
